...
// The second Navbar is about accessing the world of a character, if you are visiting someone else's character.
...
// React states: How can I make sure the world is "logged in" or not?
                ...
                <ul className="nav nav-pills flex-column mb-auto">
                    <li className="nav-item">
                        <Link to={`/worlds/${selectedWorld.worldId}`}>
                            <img src={`/${selectedWorld.worldIcon}`} style={{width: "48px", height: "48px", marginRight: "16px"}}></img>
