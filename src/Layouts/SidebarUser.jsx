...
const SidebarUser = (selectedUser) => {
    ...
    <div className="d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary" style={{width: "280px", height: "100vh"}}>
        ...
        <ul className="nav nav-pills flex-column mb-auto">
            ...
            <li className="nav-item">
                <a className="nav-link" aria-current="page" href="#">{selectedUser.username}'s Bulletins</a>
                <a className="nav-link" aria-current="page" href="#">{selectedUser.username}'s Characters</a>
                {/* This page will not only list the universes you made, but all universes you are currently in */}
                {/* They will be divided later on */}
                <a className="nav-link" aria-current="page" href="#">{selectedUser.username}'s Worlds</a>
            </li>
            ...
            {/* <li className="nav-item">
                ...
                <a className="dropdown-item" href="#">{selectedUser.username}'s Profile</a>
            </li> */}
        </ul>
    </div>
  )
